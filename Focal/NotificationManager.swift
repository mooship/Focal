...
final class NotificationManager {
    ...
    /// schedules a new one to fire after the configured threshold, naming `taskTitle` in the body
    /// if given. Turns notifications off in Settings if scheduling fails.
